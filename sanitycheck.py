...
def check_get_tests(
    ...
    if not test_functions_for_get:
        ...
        return TEST_FOR_GET_METHOD_RESPONSE_CODE, TEST_FOR_GET_METHOD_RESPONSE_BODY, warning_count, sanity_test_passing


def check_post_tests(
    ...
    if not test_functions_for_post:
        ...
        return \
            TEST_FOR_POST_METHOD_RESPONSE_CODE, \
            TEST_FOR_POST_METHOD_RESPONSE_BODY, \
            COUNT_POST_METHOD_TEST_FOR_INFERENCE_RESULT, \
            warning_count, sanity_test_passing
...
def run_sanity_check(test_dir):
    ...
    TEST_FOR_GET_METHOD_RESPONSE_CODE, TEST_FOR_GET_METHOD_RESPONSE_BODY, WARNING_COUNT, SANITY_TEST_PASSING = \
        check_get_tests(test_functions_for_get, module, WARNING_COUNT, SANITY_TEST_PASSING)
    TEST_FOR_POST_METHOD_RESPONSE_CODE, TEST_FOR_POST_METHOD_RESPONSE_BODY, \
        COUNT_POST_METHOD_TEST_FOR_INFERENCE_RESULT, WARNING_COUNT, SANITY_TEST_PASSING = \
        check_post_tests(test_functions_for_post, module, WARNING_COUNT, SANITY_TEST_PASSING)
